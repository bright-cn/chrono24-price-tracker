...
Info  : https://bright.cn/products/insights/price-tracker/chrono24
"""
...
# https://bright.cn/products/web-scraper/chrono24
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Chrono24 scraper at: https://bright.cn/products/web-scraper/chrono24\n"
